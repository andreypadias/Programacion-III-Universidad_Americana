...
{
    public class CuentaPremium : ICuentaBancaria
    {
        private decimal saldo;
        private readonly string numeroCuenta;
        private readonly decimal tasaInteres = 0.05m; // 5% anual
        private readonly decimal bonificacion = 0.01m; // 1% adicional
        ...
        public string ObtenerTipoCuenta() => "Cuenta Premium";
