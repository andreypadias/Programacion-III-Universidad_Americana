...
namespace UnoAmuchos.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDepartamento,Nombre,Descripcion")] Departamento departamento)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDepartamento,Nombre,Descripcion")] Departamento departamento)
        {
