...
namespace MuchosAmuchos.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCurso,Nombre,Descripcion")] Curso curso)
        {
            try
            {
                _context.Add(curso);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCurso,Nombre,Descripcion")] Curso curso)
        {
            if (id != curso.IdCurso)
            {
                return NotFound();
